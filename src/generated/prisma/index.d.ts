...
export namespace Prisma {
  ...
  */
    ...
    model: {
      ...
      Wish: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.WishFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.WishAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    ...
    Wish?: boolean | UserCountOutputTypeCountWishArgs
  }
  ...
  export type UserSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    Wish?: boolean | User$WishArgs<ExtArgs>
  ...
  export interface Prisma__UserClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    ...
    Wish<T extends User$WishArgs<ExtArgs> = {}>(args?: Subset<T, User$WishArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$WishPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
   ...
   * User.Wish
   */
  export type User$WishArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
  ...
  export type WishOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "name" | "description" | "links" | "status" | "priority" | "isPublic" | "createdAt" | "updatedAt" | "fullfilledOn" | "userId", ExtArgs["result"]["wish"]>
  ...
  export interface WishDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more Wishes that matches the filter.
     * @param {WishFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const wish = await prisma.wish.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: WishFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Wish.
     * @param {WishAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const wish = await prisma.wish.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: WishAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface WishFieldRefs {
    ...
    readonly links: FieldRef<"Wish", 'String[]'>
    readonly status: FieldRef<"Wish", 'WishStatus'>
    readonly priority: FieldRef<"Wish", 'PriorityLevel'>
    readonly isPublic: FieldRef<"Wish", 'Boolean'>
    readonly createdAt: FieldRef<"Wish", 'DateTime'>
    readonly updatedAt: FieldRef<"Wish", 'DateTime'>
    readonly fullfilledOn: FieldRef<"Wish", 'DateTime'>
   ...
   * Wish findRaw
   */
  export type WishFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Wish aggregateRaw
   */
  export type WishAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type UserOrderByWithRelationInput = {
    ...
    Wish?: WishOrderByRelationAggregateInput
  }
  ...
  export type WishWhereInput = {
    ...
    description?: StringFilter<"Wish"> | string
    links?: StringNullableListFilter<"Wish">
    status?: EnumWishStatusFilter<"Wish"> | $Enums.WishStatus
    priority?: EnumPriorityLevelFilter<"Wish"> | $Enums.PriorityLevel
    isPublic?: BoolFilter<"Wish"> | boolean
    createdAt?: DateTimeFilter<"Wish"> | Date | string
    updatedAt?: DateTimeFilter<"Wish"> | Date | string
    fullfilledOn?: DateTimeNullableFilter<"Wish"> | Date | string | null
  ...
  export type WishScalarWhereWithAggregatesInput = {
    ...
    description?: StringWithAggregatesFilter<"Wish"> | string
    links?: StringNullableListFilter<"Wish">
    status?: EnumWishStatusWithAggregatesFilter<"Wish"> | $Enums.WishStatus
    priority?: EnumPriorityLevelWithAggregatesFilter<"Wish"> | $Enums.PriorityLevel
    isPublic?: BoolWithAggregatesFilter<"Wish"> | boolean
    createdAt?: DateTimeWithAggregatesFilter<"Wish"> | Date | string
    updatedAt?: DateTimeWithAggregatesFilter<"Wish"> | Date | string
    fullfilledOn?: DateTimeNullableWithAggregatesFilter<"Wish"> | Date | string | null
  ...
  export type UserCreateInput = {
    ...
    Wish?: WishCreateNestedManyWithoutUserInput
  }
  ...
  export type UserUncheckedCreateInput = {
    ...
    Wish?: WishUncheckedCreateNestedManyWithoutUserInput
  }
  ...
  export type UserUpdateInput = {
    ...
    Wish?: WishUpdateManyWithoutUserNestedInput
  }
  ...
  export type UserUncheckedUpdateInput = {
    ...
    Wish?: WishUncheckedUpdateManyWithoutUserNestedInput
  }
  ...
  export type WishCreateInput = {
    ...
    name: string
    description: string
    links?: WishCreatelinksInput | string[]
    status?: $Enums.WishStatus
    priority?: $Enums.PriorityLevel
    isPublic?: boolean
    createdAt?: Date | string
    updatedAt?: Date | string
    fullfilledOn?: Date | string | null
  ...
  export type WishUpdateInput = {
    ...
    links?: WishUpdatelinksInput | string[]
    ...
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
    fullfilledOn?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
  ...
  export type WishCreatelinksInput = {
    set: string[]
  }
  ...
  export type WishUpdatelinksInput = {
    set?: string[]
    push?: string | string[]
  }
  ...
  export type UserUncheckedCreateWithoutWishInput = {
    id?: string
    name: string
    email: string
    emailVerified?: Date | string | null
  ...
  export type UserUpsertWithoutWishInput = {
    update: XOR<UserUpdateWithoutWishInput, UserUncheckedUpdateWithoutWishInput>
    create: XOR<UserCreateWithoutWishInput, UserUncheckedCreateWithoutWishInput>
    where?: UserWhereInput
  }

  export type UserUpdateToOneWithWhereWithoutWishInput = {
    where?: UserWhereInput
    data: XOR<UserUpdateWithoutWishInput, UserUncheckedUpdateWithoutWishInput>
  }

  export type UserUpdateWithoutWishInput = {
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    emailVerified?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type UserUncheckedUpdateWithoutWishInput = {
    name?: StringFieldUpdateOperationsInput | string
    email?: StringFieldUpdateOperationsInput | string
    emailVerified?: NullableDateTimeFieldUpdateOperationsInput | Date | string | null
    password?: NullableStringFieldUpdateOperationsInput | string | null
